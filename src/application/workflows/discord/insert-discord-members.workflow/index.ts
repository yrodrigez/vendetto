...
import { type InsertDiscordMembersUseCase } from "@/application/usecases/discord/insert-discord-members.usecase";

@WorkflowName('insert-discord-members')
@Schedule('0 */4 * * *', { isRunningOnStartup: true }) // every 4 hours
